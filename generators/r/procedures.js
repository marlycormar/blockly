...
/**
 * @fileoverview Generating R for procedure blocks.
 * @author marlycormar@gmail.com (Marly Cormar)
 */
'use strict';

goog.provide('Blockly.R.procedures');
...
Blockly.R['procedures_callreturn'] = function(block) {
  ...
  var funcName = Blockly.R.variableDB_.getName(block.getFieldValue('NAME'),
      Blockly.Procedures.NAME_TYPE);
  var args = [];
  for (var i = 0; i < block.arguments_.length; i++) {
    args[i] = Blockly.R.valueToCode(block, 'ARG' + i,
        Blockly.R.ORDER_NONE) || 'NA';
  }
